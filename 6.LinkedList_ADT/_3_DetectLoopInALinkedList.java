public class _3_DetectLoopInALinkedList
{
	...
	public boolean isLoopExistInLinkedList(LLNode_ADT headNode)
	{
	...
	{
		_3_DetectLoopInALinkedList ll = new _3_DetectLoopInALinkedList();
		...
		System.out.println("Is loop found in linked list ? " + ll.isLoopExistInLinkedList(headNode));
	}
