public class _4_FindFirstNodeOfLoopInLinkedList
{
	...
	public LLNode_ADT firstNodeOfLoopStart(LLNode_ADT headNode)
	{
	...
	{
		_4_FindFirstNodeOfLoopInLinkedList ll = new _4_FindFirstNodeOfLoopInLinkedList();
		...
		// list
		LLNode_ADT startOfLoopNode=ll.firstNodeOfLoopStart(headNode);
		
		System.out.println("Loop starts from node with value of " + startOfLoopNode.data);
