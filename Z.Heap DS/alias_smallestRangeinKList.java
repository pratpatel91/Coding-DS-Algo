...
public class alias_smallestRangeinKList
{
	...
	public static class PairADT implements Comparable<PairADT>
	{
		...
		@Override
		public int compareTo(alias_smallestRangeinKList.PairADT pair)
		{
...
//		}
		...
		while (minHeapAPI.size() > 0)
		{
			PairADT pair = minHeapAPI.peek();
			minHeapAPI.remove();
			System.out.println("size of minheap:"+minHeapAPI.size());
			min = pair.element; // 2
			System.out.println("Min:"+pair.element);
